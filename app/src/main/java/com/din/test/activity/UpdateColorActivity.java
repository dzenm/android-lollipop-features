...
public class UpdateColorActivity extends AppCompatActivity {
    ...
    private String[] colors = new String[]{"#87CEFA", "#B3EE3A", "#DEB887", "#8A2BE2", "#FF7F00", "#87CEFA", "#FF4040", "#000080", "#BFEFFF", "#9A32CD", "#87CEFA", "#B3EE3A", "#DEB887", "#8A2BE2", "#FF7F00", "#87CEFA", "#FF4040", "#000080", "#BFEFFF", "#9A32CD"};
